...
function Handle_OnRowClick(sender,args)
{
	...
	var idrevisionesTemporales=_row.getDataItem()["idrevisionesTemporales"];
	//alert (idrevisionesTemporales);

	location.href='./?a=muestraResumenReporte&idrevisionesTemporales='+idrevisionesTemporales;
...
function submitAxaj()
{
	...
	var documentosValor = document.getElementById("documentosValor").value;
...
function iniciaResumen()
{
	...
	{	
		...
		// parametros="?a=comenzarReporteConsolidada&fileD="+fileD+"&filaConsolidada="+filaConsolidada+"&filaAnalitica="+filaAnalitica+"&filaAnalitica2="+filaAnalitica2+"&filaResumen="+filaResumen+"&filaConsolidada2="+filaConsolidada2+"&filaResumen2="+filaResumen2+"&hojaConsolidada="+hojaConsolidada+"&hojaAnalitica="+hojaAnalitica+"&hojaResumen="+hojaResumen;
		// location.href="./index.php"+parametros;
...
function cuentaProceso(fileD)
{
	...
	{	
		...
		idrevisionesTemporales=totales[3];
		terminado=totales[4];
