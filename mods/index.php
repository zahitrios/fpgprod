<?php
	...
	$ds->SelectCommand = "SELECT * FROM modulos ORDER BY orden ASC";
	...
	$column->DataField = "idmodulos";
	$column->ReadOnly = true;
	$grid->MasterTable->AddColumn($column);

	$column = new GridBoundColumn();
	$column->HeaderText = "Orden";
	...
	$column = new GridBoundColumn();
	$column->HeaderText = "Directorio";
	$column->DataField = "directorio";
	$grid->MasterTable->AddColumn($column);
